...
import bf.esiupb.controleur.exceptions.NonexistentEntityException;
import bf.esiupb.controleur.exceptions.PreexistingEntityException;
 ...
 */
public class EtudiantJPAFacade implements Serializable {

    public EtudiantJPAFacade(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void edit(Etudiant etudiant) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                Integer id = etudiant.getMatricule();
